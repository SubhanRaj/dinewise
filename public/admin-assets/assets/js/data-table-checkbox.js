    ...
    /* eslint-enable */
                ...
                if (ctx.aoColumns[i].checkboxes){
                   ...
                   if(ctx.aoColumns[i].mRender === null){
                      colOptions['render'] = function(){
                         return '<input type="checkbox" class="dt-checkboxes form-check-input" autocomplete="off">';
                      };
                   }
       ...
       */
       Checkboxes.defaults = {
          ...
          */
          selectAllRender: '<input type="checkbox" class="form-check-input" autocomplete="off">'
       };
