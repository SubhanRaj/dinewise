...
@push('title')
    <title> Move & Edit Follow Up Inquiry </title>
@endpush
                        ...
                        <div class="ps-3">
                            <nav aria-th="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Move & Edit Follow Up Inquiry
                                    </li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="col-12 p-0">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="pt-2 text-primary">Move & Edit Follow Up Inquiry</h6>
                            </div>
                            <div class="card-body">

                                <div class="row">
                                    <div class="col-12 d-flex justify-content-center align-items-center mb-3">
                                        <img src="{{ asset('admin-assets/assets/images/icons/deadline.png') }}"
                                            alt="">
                                    </div>
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        <div class="p-3 border">
                                            <form method="POST" enctype="multipart/form-data" id="form1"
                                                onsubmit="uploadData1('form1', '{{ route('reception.saveFollowUpInquiry', $data[0]->id) }}', 'alert-box1', 'btn-box', event)">
                                                @csrf
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 mb-3">
                                                        ...
                                                        <input type="date" class="form-control" name="follow_up_date"
                                                            required value="{{ $data[0]->follow_up_date }}">
                                                    </div>
                                                    <div
