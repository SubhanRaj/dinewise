        ...
        <div class="sidebar-wrapper" data-simplebar="true">
            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    ...
                    <ul>
                        <li> <a href="{{ route('reception.addInquiryIndex') }}"><i
                                    class="bx bx-right-arrow-alt"></i>Add
                                Inquiry</a>
                        </li>
                        <li> <a href="{{ route('reception.showInquiry') }}"><i
                                    class="bx bx-right-arrow-alt"></i>Inquiry
                                Details</a>
                        </li>
                        <li> <a href="{{ route('reception.showFollowUpInquiry') }}"><i
                                    class="bx bx-right-arrow-alt"></i>Follow Up</a>
                        </li>
                        <li> <a href="{{ route('reception.showSuccessfullInquiry') }}"><i
                                    class="bx bx-right-arrow-alt"></i>Successfull Inquiry</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        <li> <a href="{{ route('reception.addReceptionIndex') }}"><i
                                    class="bx bx-right-arrow-alt"></i>Add
                                Logs</a>
                        </li>
                        <li> <a href="{{ route('reception.showReceptionIndex') }}"><i
                                    class="bx bx-right-arrow-alt"></i>Logs Details</a>
                        </li>
                    </ul>
                </li>
                ...
                <nav class="navbar navbar-expand">
                    ...
                    <div class="user-box dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="{{ route('reception.logout') }}"><i
