    ...
    <div class="wrapper">
        ...
        <div class="sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header">
                <div>
                    <img src="{{ asset('admin-assets/assets/images/logo.png') }}" class="logo-icon logo-big" alt="logo icon">
                    <img src="{{ asset('admin-assets/assets/images/logo-sm.png') }}" class="logo-icon d-none logo-sm" alt="logo icon">
                </div>
            ...
            <ul class="metismenu" id="menu">
                <li>
                    <a href="{{ route('reception.indexView') }}">
                ...
                <li>
                    ...
                    <ul>
                        <li> <a href="{{ route('reception.addInquiryIndex') }}"><i class="bx bx-right-arrow-alt"></i>Add
                                Inquiry</a>
                        </li>
                        <li> <a href="{{ route('reception.showInquiry') }}"><i class="bx bx-right-arrow-alt"></i>Inquiry
                                Details</a>
                        </li>
                        <li> <a href="{{ route('reception.showFollowUpInquiry') }}"><i class="bx bx-right-arrow-alt"></i>Follow Up</a>
                        </li>
                        <li> <a href="{{ route('reception.showSuccessfullInquiry') }}"><i class="bx bx-right-arrow-alt"></i>Successfull Inquiry</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        <li> <a href="{{ route('reception.addReceptionIndex') }}"><i class="bx bx-right-arrow-alt"></i>Add
                                Logs</a>
                        </li>
                        <li> <a href="{{ route('reception.showReceptionIndex') }}"><i class="bx bx-right-arrow-alt"></i>Logs Details</a>
                        </li>
                    </ul>
                </li>
                ...
                <nav class="navbar navbar-expand">
                    ...
                    <div class="user-box dropdown">
                        <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="{{ asset('admin-assets/assets/images/digi-user.png') }}" class="user-img" alt="user avatar">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="{{ route('reception.logout') }}"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
                            </li>
                        </ul>
                    </div>
                </nav>
