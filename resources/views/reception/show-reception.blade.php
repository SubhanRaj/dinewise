                                        ...
                                        <div class="d-flex justify-content-end align-items-center"
                                            ...
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                <button type="button" class="btn btn-danger disabled-btn"
                                                    ...
                                                    disabled
                                                    onclick="deleteConfirm('reception-delete-all','reception', 'false','','')"><i
                                                        class="bx bx-trash"></i>
                                                    <input type="hidden" value="" id="reception-delete-all">
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <table id="reception-table"
                                        ...
                                        <thead class="bg-light border-0">
                                            <tr>
                                                ...
                                                <th class="sort text-nowrap">Visitor Name</th>
                                                <th class="sort text-nowrap">Phone Number </th>
                                                <th class="sort text-nowrap">Purpose </th>
                                                <th class="sort text-nowrap">Year </th>
                                                <th class="sort text-nowrap">Month </th>
                                                <th class="sort text-nowrap">Date </th>
                                                <th class="sort text-nowrap">Entry Time</th>
                                                <th class="sort text-nowrap">Exit Time</th>
