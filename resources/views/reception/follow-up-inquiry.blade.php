...
@push('title')
    <title>Follow Up Inquiry Details </title>
@endpush
                        ...
                        <div class="ps-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Follow Up Inquiry Details</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                                        ...
                                        <div class="d-flex justify-content-end align-items-center"
                                            ...
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                <button type="button" class="btn btn-primary disabled-btn"
                                                    ...
                                                    disabled onclick="removeFollowUp('follow-up-inquiry-remove-all')"><i
                                                        class="fas fa-arrow-right"></i>
                                                    <input type="hidden" value="" id="follow-up-inquiry-remove-all">
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body p-0">
                                <div class="mt-2 mx-2 mb-3">
                                    <table id="follow-up-inquiry-table"
                                        ...
                                        <thead class="bg-light border-0">
                                            <tr>
                                                ...
                                                <th class="sort text-nowrap">Follow Up Date </th>
