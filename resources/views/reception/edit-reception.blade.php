                    ...
                    <div class="col-12 p-0">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="pt-2 text-primary">Edit Log</h6>
                            </div>
                            <div class="card-body">


                                <form method="POST" enctype="multipart/form-data" id="form1"
                                    onsubmit="uploadData1('form1', '{{ route('reception.updateReception', $data[0]->id) }}', 'alert-box1', 'btn-box', event)">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="visitor_name" required
                                                placeholder="Visitor Name" value="{{ $data[0]->name }}">
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="purpose" required
                                                placeholder="Purpose" value="{{ $data[0]->purpose }}">
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            ...
                                            <input type="time" class="form-control" name="entry_time" required
                                                placeholder="Entry Time" value="{{ $data[0]->entry_time }}">
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            ...
                                            <input type="time" class="form-control" name="exit_time"
                                                placeholder="Exit Time" value="{{ $data[0]->exit_time }}">
