                        ...
                        <div class="card">
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex justify-content-end align-items-center"
                                            ...
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <button type="button" onclick="show_modal('export-inquiry')" class="btn btn-success">
                                                    <i class="fas fa-file-excel"></i>
                                                </button>
                                                <a href="{{ route('reception.addInquiryIndex') }}" data-bs-toggle="tooltip"
                                                ...
                                                <button type="button" class="btn btn-danger disabled-btn"
                                                    ...
                                                    disabled
                                                    onclick="deleteConfirm('inquiry-delete-all','inquiry', 'false','','')"><i
                                                        class="bx bx-trash"></i>
                                                    <input type="hidden" value="" id="inquiry-delete-all">
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body p-0">
                                <div class="mt-2 mx-2 mb-3">
                                    <table id="inquiry-table" class="table table-hover table-borderless w-100 border-bottom"
