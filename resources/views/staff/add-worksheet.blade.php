                    ...
                    <div class="col-12 p-0">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="pt-2 text-primary">Add Work In Daily Worksheet</h6>
                            </div>
                            <div class="card-body">


                                <form method="POST" enctype="multipart/form-data" id="form1"
                                    onsubmit="uploadData1('form1', '{{ route('staff.saveWorks') }}', 'alert-box1', 'btn-box', event)">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <textarea name="description" rows="5" class="form-control" required placeholder="Work Description"></textarea>
