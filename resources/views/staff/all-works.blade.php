                        ...
                        <div class="ps-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"> All Works Details</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-0">
                                <div class="mt-2 mx-2 mb-3">
                                    <table id="staff-work-table"
                                        class="table table-hover table-borderless w-100 border-bottom"
                                        style="min-width: 500px">
                                        <thead class="bg-light border-0">
                                            <tr>
                                                <th class="sort text-nowrap">Work Title</th>
                                                <th class="sort text-nowrap">Work Description</th>
                                                <th class="sort text-nowrap">Starting Date</th>
                                                <th class="sort text-nowrap">Deadline</th>
