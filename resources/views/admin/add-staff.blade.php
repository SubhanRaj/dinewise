                    ...
                    <div class="col-12 p-0">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="pt-2 text-primary">Add Staff</h6>
                            </div>
                            <div class="card-body">


                                <form method="POST" enctype="multipart/form-data" id="form1"
                                    onsubmit="uploadData1('form1', '{{ route('admin.addStaffSave') }}', 'alert-box1', 'btn-box', event)">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <div class="border border-dashed p-3">
                                                <div class="selected-media-box" id="selected-media-box">
                                                    {{-- =========== Media will be create dynamically =========== --}}
                                                    <input type="hidden" name="profile_picture"
                                                        id="final-selected-media-input" value="">
                                                    <p class="form-feedback invalid-feedback" data-name="profile_picture">
                                                    </p>
                                                </div>
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <div class="border border-dashed p-3">
                                                <div class="selected-media-box" id="selected-media-box2">
                                                    ...
                                                    <p class="form-feedback invalid-feedback" data-name="documents"> </p>
                                                </div>
                                                <div class="d-flex justify-content-center align-items-center mt-2">
