                             ...
                             <div class="card-header border-bottom">
                                 <div class="row">
                                     <div
                                         ...
                                         <h6 class="text-primary" style="font-size: 16px">All Staff Details</h6>
                                     </div>
                                     <div
                                         class="col-md-8 d-flex justify-content-md-end justify-content-center align-items-center">
                                         <div class="d-flex justify-content-end align-items-center" id="Staff-table-action">
                                             ...
                                             <div class="btn-group" role="group" aria-label="Basic example">
                                                 <a href="{{ route('admin.staffExport') }}" class="btn btn-success">
                                                     <i class="fas fa-file-excel"></i>
                                                 </a>
                                                 <a href="{{ route('admin.addStaffIndex') }}" data-bs-toggle="tooltip"
                                                     data-bs-placement="auto" data-bs-title="Add New"
                                                     class="btn btn-primary"><i class="fa-solid fa-plus"></i>
                                                 </a>
                                                 <a href="{{ route('admin.Trash', 'staff-trash') }}"
                                                 ...
                                                 <button type="button" class="btn btn-danger disabled-btn"
                                                     ...
                                                     onclick="deleteConfirm('Staff-delete-all','staffs', 'false','','')"><i
                                                         class="bx bx-trash"></i>
                                                     <input type="hidden" value="" id="Staff-delete-all">
                                                 </button>
                                             </div>
                             ...
                             <div class="card-body p-0">
                                 <div class="mt-2 mx-2 mb-3">
                                     <table id="Staff-table"
                                         class="img-table table table-hover table-borderless w-100 border-bottom"
