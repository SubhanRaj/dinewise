@extends('admin.main')
@push('title')
    <title>Edit Advance Payment Details </title>
@endpush
@section('main-section')
                        ...
                        <div class="ps-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Edit Advance Payment</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12 p-0">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="pt-2 text-primary">Edit Advance Payment</h6>
                            </div>
                            <div class="card-body">


                                <form method="POST" enctype="multipart/form-data" id="form1"
                                    onsubmit="uploadData1('form1', '{{ route('admin.updateAdvancePayment', $data[0]->id) }}', 'alert-box1', 'btn-box', event)">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            ...
                                            <input type="number" class="form-control yearpicker" name="year" required
    ...
    @push('scripts')
        <script>
            ...
            let year_value = $('.yearpicker').attr('data-value')
