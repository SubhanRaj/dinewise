                        ...
                        <div class="card">
                            <div class="card-header border-bottom">
                                <div class="row">
                                    <div
                                        ...
                                        <h6 class="text-primary" style="font-size: 16px">All Users Details</h6>
                                    </div>
                                    <div
                                        class="col-md-8 d-flex justify-content-md-end justify-content-center align-items-center">
                                        <div class="d-flex justify-content-end align-items-center" id="users-table-action">
                                            ...
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                <a href="{{ route('admin.addUsers') }}" data-bs-toggle="tooltip"
                                                ...
                                                <button type="button" class="btn btn-danger disabled-btn"
                                                    ...
                                                    disabled
                                                    onclick="deleteConfirm('users-delete-all','logins', 'false','','')"><i
                                                        class="bx bx-trash"></i>
                                                    <input type="hidden" value="" id="users-delete-all">
                                                </button>
                                            </div>
                            ...
                            <div class="card-body p-0">
                                <div class="mt-2 mx-2 mb-3">
                                    <table id="users-table" class="table table-hover table-borderless w-100 border-bottom"
                                        ...
                                        <thead class="bg-light border-0">
                                            <tr>
                                                ...
                                                <th class="sort text-nowrap">2 FA</th>
