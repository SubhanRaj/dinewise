...
@section('main-section')
                        ...
                        <div class="card">
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex justify-content-end align-items-center"
                                            ...
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                <a href="{{ route('admin.Trash', 'loyalty-trash') }}"
                                                ...
                                                <button type="button" class="btn btn-danger disabled-btn"
                                                    ...
                                                    onclick="deleteConfirm('setting-delete-all','loyalty', 'false','','')">
                                                    <i class="fa-regular fa-trash"></i>
                                                    <input type="hidden" value="" id="setting-delete-all">
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body p-0">
                                <div class="mt-2 mx-2 mb-3">
                                    <table id="setting-table" class="table table-hover table-borderless w-100 border-bottom"
                                        style="min-width: 500px">
                                        <thead class="bg-light border-0">
                                            <tr>
                                                <th></th>
                                                <th class="sort text-nowrap">Min Order Amount</th>
                                                <th class="sort text-nowrap">Points</th>
    ...
    @push('scripts')
        <script>
            ...
            initServerSideDataTable('setting-table', '/admin/show-loyalty', 'setting-selected',
                createColumn(Column),
