                                    ...
                                    <div
                                        ...
                                        <div class="d-flex justify-content-end align-items-center"
                                            ...
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a href="{{ route('admin.addMaterialIndex') }}" data-bs-toggle="tooltip"
                                                    data-bs-placement="auto" data-bs-title="Add New"
                                                    class="btn btn-primary"><i class="fa-regular fa-plus"></i>
                                                </a>
                                                <a href="{{ route('admin.Trash', 'material-trash') }}"
                                                ...
                                                <button type="button" class="btn btn-danger disabled-btn"
                                                    ...
                                                    onclick="deleteConfirm('material-delete-all','product_materials', 'false','','')">
                                                    <i class="fa-regular fa-trash"></i>
                                                    <input type="hidden" value="" id="material-delete-all">
                                                </button>
                                            </div>
                                        </div>
                                    </div>
