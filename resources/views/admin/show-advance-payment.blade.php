                        ...
                        <div class="ps-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"> Advance Payments</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-header border-bottom">
                                <div class="row">
                                    <div
                                        ...
                                        <h6 class="text-primary" style="font-size: 16px"> Advance Payment Details
                                        </h6>
                                    </div>
                                    <div
                                        class="col-md-8 d-flex justify-content-md-end justify-content-center align-items-center">
                                        <div class="d-flex justify-content-end align-items-center"
                                            id="advance-payment-table-action">
                                            <div class="d-flex justify-content-center align-items-center checkbox-selected"
                                                id="advance-payment-selected">
                                                {{-- No. of Selected Item will show here  --}}
                                            </div>

                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <button type="button"
                                                    onclick="exportSetting('advance_payment','exportModal1','{{ route('admin.exportAdvancePaymentData') }}')"
                                                    class="btn btn-success">
                                                    <i class="fas fa-file-excel"></i>
                                                </button>
                                                <a href="{{ route('admin.addAdvancePaymentIndex') }}"
                                                    data-bs-toggle="tooltip" data-bs-placement="auto"
                                                    data-bs-title="Add New" class="btn btn-primary"><i
                                                        class="bx bx-plus"></i>
                                                </a>
                                                <a href="{{ route('admin.Trash', 'advance-payment-trash') }}"
                                                    data-bs-toggle="tooltip" data-bs-placement="auto"
                                                ...
                                                <button type="button" class="btn btn-danger disabled-btn"
                                                    ...
                                                    disabled
                                                    onclick="deleteConfirm('advance-payment-delete-all','advance_payment', 'false','','')"><i
                                                        class="bx bx-trash"></i>
                                                    <input type="hidden" value="" id="advance-payment-delete-all">
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body p-0">
                                <div class="mt-2 mx-2 mb-3">
                                    <table id="advance-payment-table"
