@extends('admin.main')
@push('title')
    <title>Define Staff Payment Details </title>
@endpush
                    ...
                    <div class="col-12 p-0">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="pt-2 text-primary">Define Salary</h6>
                            </div>
                            <div class="card-body">


                                <form method="POST" enctype="multipart/form-data" id="form1"
                                    onsubmit="uploadData1('form1', '{{ route('admin.saveDefineSalary') }}', 'alert-box1', 'btn-box', event)">
                                    @csrf
                                    <div class="row">
