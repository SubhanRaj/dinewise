                    ...
                    <div class="col-12 p-0 mt-4">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h6 class="text-primary" style="font-size: 16px">Edit Table</h6>
                            </div>
                            <div class="card-body">
                                <form method="POST" id="table-form"
                                    onsubmit="uploadData1('table-form','{{ route('admin.editTable', $data->id) }}', 'alert-box', 'btn-box-1', event)"
                                    ...
                                    <div class="row">
                                        <div class="col-12 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="table_number" required
                                                placeholder="Table Number" value="{{ $data->table_no }}">
                                    ...
                                    <div class="row">
                                        <div class="col-12 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="capacity" required
                                                placeholder="Capacity" value="{{ $data->capacity }}">
