                        ...
                        <div class="ps-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"> All Leave Details</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-header border-bottom">
                                <div class="row">
                                    <div
                                        ...
                                        <h6 class="text-primary" style="font-size: 16px"> All Leave Details
                                        </h6>
                                    </div>
                                    <div
                                        class="col-md-8 d-flex justify-content-md-end justify-content-center align-items-center">
                                        <div class="d-flex justify-content-end align-items-center" id="leave-table-action">
                                            ...
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a href="{{ route('admin.exportLeaveData') }}" class="btn btn-success">
                                                    <i class="fas fa-file-excel"></i>
                                                </a>
                                                <a href="{{ route('admin.addLeave') }}" data-bs-toggle="tooltip"
                                                    data-bs-placement="auto" data-bs-title="Add New"
                                                    class="btn btn-primary"><i class="bx bx-plus"></i>
                                                </a>
                                                <a href="{{ route('admin.Trash', 'leave-trash') }}" data-bs-toggle="tooltip"
                                                ...
                                                <button type="button" class="btn btn-danger disabled-btn"
                                                    ...
                                                    disabled
                                                    onclick="deleteConfirm('leave-delete-all','leaves', 'false','','')"><i
                                                        class="bx bx-trash"></i>
                                                    <input type="hidden" value="" id="leave-delete-all">
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body p-0">
                                <div class="mt-2 mx-2 mb-3">
                                    <table id="leave-table" class="table table-hover table-borderless w-100 border-bottom"
