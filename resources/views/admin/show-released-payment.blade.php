@extends('admin.main')
@push('title')
    <title> Released Payment Details </title>
@endpush
                        ...
                        <div class="ps-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"> Released Payment </li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex justify-content-end align-items-center"
                                            ...
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                <a href="{{ route('admin.Trash', 'released-trash') }}"
                                                ...
                                                <button type="button" class="btn btn-danger disabled-btn"
                                                    ...
                                                    disabled
                                                    onclick="deleteConfirm('released-payment-delete-all','released_payment', 'false','','')"><i
                                                        class="bx bx-trash"></i>
                                                    <input type="hidden" value="" id="released-payment-delete-all">
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body p-0">
                                <div class="mt-2 mx-2 mb-3">
                                    <table id="released-payment-table"
