                        ...
                        <div class="card">
                                        ...
                                        <div class="d-flex justify-content-end align-items-center"
                                            ...
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                <button type="button" class="btn btn-danger disabled-btn"
                                                    ...
                                                    disabled
                                                    onclick="deleteConfirm('staff-define-payment-delete-all','define_salary', 'false','','')"><i
                                                        class="bx bx-trash"></i>
                                                    <input type="hidden" value=""
                                                        id="staff-define-payment-delete-all">
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body p-0">
                                <div class="mt-2 mx-2 mb-3">
                                    <table id="staff-define-payment-table"
