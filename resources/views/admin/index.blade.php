                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="widgets-icons bg-light-primary text-white ms-auto">
                                    <a href="{{ route('admin.addCategoryIndex') }}"><i class="fa-solid fa-plus text-white"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="widgets-icons bg-light-warning text-white ms-auto">
                                    <a href="{{ route('admin.addProducts') }}"><i class="fa-solid fa-plus text-white"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="widgets-icons bg-light-success text-white ms-auto">
                                    <a href="{{ route('admin.addTableIndex') }}"><i class="fa-solid fa-plus text-white"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="widgets-icons bg-light-info text-white ms-auto">
                                    <a href="{{ route('admin.addOrder') }}"><i class="fa-solid fa-plus text-white"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="dash-table-block-box">
                        ...
                        <div class="table-block shadow bg-gradient-bloody cursor-pointer position-relative">
                            ...
                            <div class='dropdown action-dropdown position-absolute' style="top: 5px;right:10px">
                                ...
                                <div class='dropdown-menu border py-2'>
                                    <a class='dropdown-item' href='{{ route('admin.orderDetails', $single_table_block['order_id']) }}'><i class='fas fa-eye text-primary'></i> View</a>
                                    <a class='dropdown-item' href='javascript:;' onclick="editOrder('{{ $single_table_block['order_id'] }}','{{ route('admin.addOrder') }}')"><i class='fas fa-edit text-primary'></i> Edit</a>
                        ...
                        @else
                        <div class="table-block shadow bg-gradient-lush cursor-pointer" onclick="selectTableFromDashboard('{{ $single_table_block['table_no'] }}' , '{{ route('admin.addOrder') }}')">
                            <span>{{ $single_table_block['table_no'] }}</span>
                        </div>
                        @endif
                        @endforeach
                        ...
                        <div class="card-header pb-0 bg-warning">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    <select class="form-control py-1 mb-1 font-13" id="booking-filter" style="width:120px">
                                        @php
                                        echo showMonth();
                                        @endphp
                                    </select>
                                    <button type="button" class="btn btn-dark py-1 font-13 mb-1" onclick="getBookingDataOnChange('booking-filter')"><i class="fa-regular fa-magnifying-glass"></i></button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body p-0">
                            <div class="row-2-box overflow-control">
                                ...
                                <div class="data-not-found">
                                    <img src="{{ asset('admin-assets/assets/images/icons/not-found.webp') }}" height="100">
                                </div>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header pb-0 bg-info">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    <select class="form-control py-1 mb-1 font-13" id="all-order-filter" style="width:120px">
                                        @php
                                        echo showMonth();
                                        @endphp
                                    </select>
                                    <button type="button" class="btn btn-dark py-1 font-13 mb-1" onclick="getOrderDataOnChange('all-order-filter')"><i class="fa-regular fa-magnifying-glass"></i></button>
                                </div>
                            </div>
                        </div>
                        <div class="card-body p-0">
                            ...
                            <div class="row-2-box overflow-control">
                                ...
                                <table class="table w-100 table-borderless table-hover p-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="text-center"> <a href="javascript:;" onclick="editOrder('{{ $single_orders->order_id }}','{{ route('admin.addOrder') }}')">{{ $single_orders->order_id }}</a>
                                            </td>
                                            <td class="text-center">
                                                <a href="javascript:;" onclick="showProductData({{ $single_orders->id }})" class="text-primary">View</a>
                                            </td>
                                            <td class="text-center">
                    ...
                    <div class="card position-relative">
                        <div class="card-header pb-1 bg-warning">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    <select class="form-control py-1 mb-1 font-13" id="booking-chart" style="width:120px">
                                        @php
                                    ...
                                    <button type="button" class="btn btn-dark py-1 font-13 mb-1" onclick="getBookingChartOnClick('booking-chart')">
                    ...
                    <div class="card position-relative">
                        <div class="card-header pb-1 bg-warning">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    <select class="form-control py-1 mb-1 font-13" style="width:120px" id="order-chart">
                                        @php
                                    ...
                                    <button type="button" class="btn btn-dark py-1 font-13 mb-1" onclick="getOrderChartOnClick('order-chart')"><i class="fa-regular fa-magnifying-glass"></i></button>
                                </div>
                            </div>
                        </div>
                        <div class="card-body p-0 m-0">
