                    ...
                    <div class="col-12 p-0 mt-4">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h6 class="text-primary" style="font-size: 16px">Edit Pricing Unit</h6>
                            </div>
                            <div class="card-body">

                                {{-- <form method="POST" id="pricing-form"
                                    action="{{ route('admin.updatepricing', $data->id) }}" class="mx-3 p-3"
                                    enctype="multipart/form-data"> --}}
                                <form method="POST" id="pricing-form"
                                    onsubmit="uploadData1('pricing-form','{{ route('admin.updatePricingUnit', $data->id) }}', 'alert-box', 'btn-box-1', event)"
