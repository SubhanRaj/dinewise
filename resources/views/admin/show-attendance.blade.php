@extends('admin.main')
@push('title')
    <title>Show Attendance Details </title>
@endpush
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex justify-content-end align-items-center"
                                            ...
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                <button type="button"
                                                    onclick="exportSetting('attendance','exportModal1','{{ route('admin.exportAttendanceData') }}')"
                                                    class="btn btn-success">
                                                    <i class="fas fa-file-excel"></i>
                                                </button>
                                                <a href="{{ route('admin.Trash', 'attendance-trash') }}"
                                                ...
                                                <button type="button" class="btn btn-danger disabled-btn"
                                                    ...
                                                    disabled
                                                    onclick="deleteConfirm('attendance-delete-all','attendance', 'false','','')"><i
                                                        class="bx bx-trash"></i>
                                                    <input type="hidden" value="" id="attendance-delete-all">
                                                </button>
                                            </div>
                                        </div>
                                    </div>
