@extends('admin.main')
@push('title')
    <title> All Pending Leave Details </title>
@endpush
                        ...
                        <div class="ps-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"> All Pending Leave Details</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                        ...
                                        <div class="d-flex justify-content-end align-items-center"
                                            ...
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                <button type="button" class="btn btn-danger disabled-btn"
                                                    ...
                                                    disabled
                                                    onclick="deleteConfirm('pendingleave-delete-all','leaves', 'false','','')"><i
                                                        class="bx bx-trash"></i>
                                                    <input type="hidden" value="" id="pendingleave-delete-all">
                                                </button>
                                            </div>
                                        </div>
                                    </div>
